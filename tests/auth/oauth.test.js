...
const generateLinkedInAuthUrl = (state) => {
...
const generateTwitterAuthUrl = (state, codeChallenge) => {
    const params = new URLSearchParams({
        response_type: 'code',
...
const exchangeLinkedInToken = async (code, state) => {
...
const exchangeTwitterToken = async (code, codeVerifier, state) => {
    // Mock successful token exchange
...
describe('OAuth Authentication Flows', () => {
    ...
    describe('OAuth Error Handling', () => {
        ...
        it('should handle network errors during token exchange', async () => {
            ...
            const networkErrorExchange = async (code) => {
        ...
        it('should handle malformed OAuth responses', async () => {
            ...
            const malformedResponseExchange = async (code) => {
